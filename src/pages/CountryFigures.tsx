  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        {/* Navigation Tabs */}
        <div className="mb-8">
          <Tabs value="figures" className="w-full">
        ...
        <Card className="border-2">
          ...
          <CardContent>
            <p className="text-muted-foreground mb-4">
              This is the notable figures page for {country.name}. You can add detailed information about:
            </p>
            <ul className="list-disc list-inside text-muted-foreground space-y-2">
              <li>Kings, queens, and royal families</li>
              <li>Political leaders and statesmen</li>
              <li>Military commanders and heroes</li>
              <li>Scientists, inventors, and scholars</li>
              <li>Artists, writers, and cultural figures</li>
              <li>Religious and spiritual leaders</li>
            </ul>
          </CardContent>
        </Card>
      </div>
